...
class SingleActorPage {
  ...
  get backdropUrl() {
    return this.backdropPath
      ? SingleActorPage.BACKDROP_BASE_URL + this.backdropPath
      : "";
  }
}
...
class SingleActorPageMovieCredit {
  ...
  get backdropUrl() {
    return this.backdropPath
      ? SingleActorPageMovieCredit.BACKDROP_BASE_URL + this.backdropPath
      : "";
  }
}
//-----------------SingleActor End-----------------------
...
class CreditCrew {
  ...
  get backdropUrl() {
    return this.backdropPath
      ? CreditCrew.BACKDROP_BASE_URL + this.backdropPath
      : "";
  }
}
//-----------------CreditCrew End-----------------------
...
class Credit {
  ...
  get backdropUrl() {
    return this.backdropPath
      ? Credit.BACKDROP_BASE_URL + this.backdropPath
      : "";
  }
}
//-----------------Credits End-----------------------
...
class Similar {
  ...
  get backdropUrl() {
    return this.backdropPath
      ? Similar.BACKDROP_BASE_URL + this.backdropPath
      : "";
  }
}
//-----------------Similar End-----------------------
...
class Trailer {
  ...
  get backdropUrl() {
    return this.backdropPath
      ? Trailer.BACKDROP_BASE_URL + this.backdropPath
      : "";
  }
}
//-----------------Trailer End-----------------------
...
class PopularActor {
  ...
  get backdropUrl() {
    return this.backdropPath
      ? PopularActor.BACKDROP_BASE_URL + this.backdropPath
      : "";
  }
}
    ...
    container.innerHTML = `
        ...
        <div class="row overviewForTablet">
            ...
            <div class="col-md-8 col-xs-12 col-s-6 overview">
                ...
                <p id="movie-popularity">Popularity: ${
                  actorInstance.popularity
                }</p>
                <p id="movie-date">Date: ${
                  actorInstance.birthday
                } - ${deathdayVari}</p>
            </div>
         </div> 
...
class MovieSection {
  static renderMovie(movie, credits, similar, trailer, crew) {
    ...
    for (let z = 0; z < movie.production_companies.length; z++) {
      arrayForProduction.push(
        BACKDROP_BASE_URL + movie.production_companies[z].logo_path
      );
    ...
    MoviePage.container.innerHTML = `
      <div class="row overviewForTablet">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12 col-s-6 overview">
          ...
          <p id="movie-vote_average">Average Rate of Movie: ${
            movie.vote_average
          }</p>
    ...
    let actorAllMoviesPicinClass =
      document.getElementsByClassName("actorAllMoviesPic");
...
for (let i = 0; i < genresFilter.length; i++) {
  genresFilter[i].addEventListener("click", function () {
    ...
    const genreMovies = (async function () {
      ...
      const result = await allMovieList.filter((movie) =>
        movie.genre_ids.includes(specificGenre)
      );
